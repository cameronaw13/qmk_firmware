...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi_split_bs_rshift_space(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,            KC_SPC,                       KC_BSPC,            KC_RALT,  TT(2),    KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_PSCR
    ),
    ...
    [2] = LAYOUT_60_ansi_split_bs_rshift_space(
        ...
        vvvvv,    KC_P7,    KC_P8,    KC_P9,    KC_PMNS,  KC_PSLS,  _____,    KC_BTN1,  KC_MS_U,  KC_BTN2,  KC_MPLY,  KC_MPRV,            KC_MNXT,  _____,
        ...
        vvvvv,    vvvvv,    vvvvv,              KC_ENT,                       KC_DEL,             vvvvv,    vvvvv,    KC_HOME,  KC_PGDN,  KC_END,   _____
    ),
    // Extra Layer
