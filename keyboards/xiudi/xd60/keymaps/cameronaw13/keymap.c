...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_MENU_LYT_CLMK] = ACTION_TAP_DANCE_DOUBLE(KC_APP, DF(1)),
    [TD_MENU_LYT_QWTY] = ACTION_TAP_DANCE_DOUBLE(KC_APP, DF(0)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi_split_bs_rshift_space(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,    KC_0,    KC_MINS,  KC_EQL,  KC_BSPC,  TD(TD_MENU_LYT_CLMK),
    ...
    [2] = LAYOUT_60_ansi_split_bs_rshift_space(
        BL_DOWN, KC_F1,   KC_F2,   KC_F3,  KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  KC_PAUS, BL_UP,
        BL_STEP, KC_P7,   KC_P8,   KC_P9,  KC_PMNS, KC_PSLS, _____,   KC_BTN1, KC_MS_U, KC_BTN2, KC_MPLY, KC_MPRV,  KC_MNXT,          BL_BRTG,
        vvvvv,   KC_P4,   KC_P5,   KC_P6,  KC_PPLS, KC_PAST, _____,   KC_MS_L, KC_MS_D, KC_MS_R, _____,   _____,             _____,   KC_INS,
